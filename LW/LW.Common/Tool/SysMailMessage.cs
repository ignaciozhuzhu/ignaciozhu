...
namespace LW.Common.Tool
{
    ...
    public class SysMailMessage : ISmtpMail
    {
        ...
        public bool Send()
        {
            ...
            myEmail.Headers.Add("X-Priority", "3");
            myEmail.Headers.Add("X-MSMail-Priority", "Normal");
            myEmail.Headers.Add("X-Mailer", "Microsoft Outlook Express 6.00.2900.2869");
            myEmail.Headers.Add("X-MimeOLE", "Produced By Microsoft MimeOLE V6.00.2900.2869");
            myEmail.Headers.Add("ReturnReceipt", "1");
